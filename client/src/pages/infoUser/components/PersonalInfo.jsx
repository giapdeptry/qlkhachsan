...
function PersonalInfo() {
    ...
    useEffect(() => {
        ...
        if (loggedCookie !== '1' || !hasToken) {
            console.log('[PersonalInfo] User not authenticated, redirecting...');
            // Redirect will be handled by axios interceptor on API call
            return;
        }
    }, []);
            ...
            cover={
                <div className="h-40 bg-gradient-to-r from-[#e45464] to-[#d70018] relative">
                    <div className="absolute left-6 -bottom-16">
                        <Avatar
                            size={120}
                            src={`${import.meta.env.VITE_API_URL}/uploads/avatars/${userData?.avatar}`}
                            icon={<UserOutlined />}
