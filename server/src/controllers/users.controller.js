...
function setCookie(res, token, refreshToken) {
    ...
    // Production: sameSite: 'None', secure: true (for cross-origin HTTPS)
    // Development: sameSite: 'Lax', secure: false (allows localhost cross-origin)
    const cookieOptions = {
        httpOnly: true,
        secure: isProduction,
    ...
    // Cookie trạng thái login (non-httpOnly for client-side access)
...
class UserController {
    ...
    async forgotPassword(req, res) {
        ...
        res.cookie('tokenResetPassword', token, cookieOptions);
